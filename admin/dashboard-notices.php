...
<div class="notice notice-success is-dismissible <?php echo esc_attr($this->plugin_name); ?>-notice-welcome">
	<p>
		...
		printf(
			...
			esc_html__('Thank you for installing %1$s!', 'wp-utility-and-performance'),
			esc_html($this->plugin_display_name)
		);
		?>
		<a href="<?php echo esc_url($setting_page); ?>"><?php esc_html_e('Click here', 'wp-utility-and-performance'); ?></a> <?php esc_html_e('to configure the plugin.', 'wp-utility-and-performance'); ?>
	</p>
</div>
